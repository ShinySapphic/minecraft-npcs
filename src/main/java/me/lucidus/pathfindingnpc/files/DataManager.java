package me.lucidus.pathfindingnpc.files;
...
public class DataManager {
    ...
    public DataManager(NPCPlugin plugin, String fileName) {
        this.plugin = plugin;
    ...
    public void saveConfig() {
        ...
        try {
            ...
            plugin.getLogger().log(Level.SEVERE, "Error: Could not save config to " + this.configFile, e);
        }
    }
